...
export default function ApplyPage() {
  return (
    <main className="min-h-screen px-5 py-8 sm:px-8 sm:py-12">
      <div className="mx-auto grid max-w-6xl overflow-hidden border border-[var(--line)] bg-[#fbfaf6] lg:grid-cols-[0.78fr_1.22fr]">
        <section className="flex min-h-72 flex-col justify-between bg-[var(--surface-sidebar)] p-7 text-[#f5f2eb] sm:p-10 lg:min-h-[680px]">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#e9a281]">Northstar care team</p>
            <h1 className="mt-16 max-w-sm text-4xl font-semibold leading-[1.05] tracking-[-0.045em] sm:text-5xl">Your care work matters.</h1>
            <p className="mt-6 max-w-sm text-sm leading-7 text-[#c3d0c8]">Tell us a little about your experience and the kind of caregiver opportunity you are looking for.</p>
          </div>
          <p className="mt-12 text-xs uppercase tracking-[0.15em] text-[#9eb2a7]">Caregiver application · 2 minutes</p>
        </section>
